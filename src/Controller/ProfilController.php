...
class ProfilController extends AbstractController
{
    ...
    public function editProfil(User $user, Request $request, EntityManagerInterface $em)
    {
        ...
        return $this->render('/security/editProfil.html.twig', ['form' => $form->createView()]);
    }
     ...
     */
    public function editPassword(User $user, Request $request, EntityManagerInterface $em, UserPasswordEncoderInterface $encoder)
    {
        ...
        return $this->render('/security/editPassword.html.twig', ['form' => $form->createView()]);
    }
