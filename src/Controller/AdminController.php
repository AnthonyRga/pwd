...
class AdminController extends AbstractController
{
     ...
     * @IsGranted("ROLE_ADMIN")
     */
    public function editComment(Comment $comment, Request $request, EntityManagerInterface $em)
    {
        ...
        return $this->render('/admin/edit-comment.html.twig', ['form' => $form->createView()]);
    }
