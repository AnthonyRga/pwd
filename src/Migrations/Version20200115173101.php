 ...
 */
final class Version20200115173101 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE pwd_article_store (pwd_article_id INT NOT NULL, store_id INT NOT NULL, INDEX IDX_B18D47ADB092A811 (store_id), INDEX IDX_B18D47ADAD5F2021 (pwd_article_id), PRIMARY KEY(pwd_article_id, store_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB COMMENT = \'\' ');
